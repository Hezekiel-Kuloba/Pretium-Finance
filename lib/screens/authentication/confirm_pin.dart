...
class ConfirmPinScreen extends ConsumerStatefulWidget {
  final String createdPin; // Pass the created PIN from CreatePinScreen

  const ConfirmPinScreen({super.key, required this.createdPin});
...
class _ConfirmPinScreenState extends ConsumerState<ConfirmPinScreen> {
  ...
  Future<void> _handleConfirmPin() async {
    ...
    try {
      ...
      if (pin != widget.createdPin) {
        if (mounted) {
          CustomDialogs.showErrorDialog(
            context: context,
            title: AppLocalizations.of(context)!.error,
            content: AppLocalizations.of(context)!.pinsDontMatch,
          );
        }
        return;
      }
      if (mounted) {
        CustomDialogs.showSuccessDialog(
          ...
          content: AppLocalizations.of(context)!.pinConfirmed,
        ).then(
          (_) => Navigator.push(
            context,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(),
      body: Container(
        color: const Color(0xFF2E7D7D), // Teal background from image
        child: Center(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    translations.reenterYourPinToConfirm,
